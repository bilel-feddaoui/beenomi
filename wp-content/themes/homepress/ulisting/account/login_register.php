...
<div id="stm-listing-login-register" class="login-page-box">
    ...
    <div class="form-field">
        ...
        <input id="log-login" type="text" data-v-model="login" class="stm-form-control"  autocomplete="off" placeholder="<?php esc_attr_e( 'Entrer votre Tel', 'homepress' ); ?>" />
    ...
    <div class="form-field">
        ...
        <input id="log-password" type="password" data-v-model="password" class="stm-form-control" autocomplete="off" placeholder="<?php esc_attr_e( 'Entrer votre mot de passe', 'homepress' ); ?>" />
