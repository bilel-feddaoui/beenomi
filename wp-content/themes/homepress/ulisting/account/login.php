...
<div class="stm-listing-login">
	...
	<div class="form-field">
		...
		<input type="text" v-model="login" class="stm-form-control"  autocomplete="off" placeholder="<?php esc_attr_e( 'enter Tel', 'homepress' ); ?>" />
	...
	<div class="form-field">
		...
		<input type="password" v-model="password" class="stm-form-control" autocomplete="off" placeholder="<?php esc_attr_e( 'Entrer votre mot de passe', 'homepress' ); ?>" />
